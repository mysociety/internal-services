...
-- Also fix a few codes and names that have changed.
--
-- Copyright (c) 2009 UK Citizens Online Democracy. All rights reserved.
-- Email: matthew@mysociety.org; WWW: http://www.mysociety.org/
--
-- $Id: 2009-12-manual-update.sql,v 1.2 2009-12-21 23:01:39 matthew Exp $
--
...
-- Bedford
update area set ons_code='00KB', unit_id=43871 where ons_code='09UD';
...
-- Cheshire
update area set unit_id=43553 where ons_code='00EQ';
update area set unit_id=43552 where ons_code='00EW';

-- Cornwall
update area set ons_code='00HE', unit_id=43750 where ons_code='15';
...
-- Durham
update area set ons_code='00EJ', unit_id=43607 where ons_code='20';
update area_name set name='County Durham' where name='Durham County';

-- Northumberland
update area set ons_code='00EM', unit_id=43674 where ons_code='35';
update area_name set name='Northumberland' where area_id=2248 and name_type = 'O';

-- Shropshire
update area set ons_code='00GG', unit_id=43822 where ons_code='39';
...
-- Wiltshire
update area set ons_code='00HY', unit_id=43925 where ons_code='46';
...
update area set ons_code='00HF', unit_id=43972 where ons_code='15UH';
